...
## Outline
1. [Setting Up the Problem](#setting-up-the-problem)
2. [Encoding Coordinates as Signed Areas](#encoding-coordinates-as-signed-areas)
3. [How Areas Transform Under a Linear Map](#how-areas-transform-under-a-linear-map)
4. [Deriving Cramer's Rule](#deriving-cramers-rule)
5. [Extension to Three Dimensions and Beyond](#extension-to-three-dimensions-and-beyond)
6. [Practical Role and Limitations](#practical-role-and-limitations)
