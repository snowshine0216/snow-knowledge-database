...
> #### Q1 — 主代理与子代理角色划分
> 
> 主代理是指挥官，子代理是专业兵种，各有明确职责与受限权限——例如负责代码审查的子代理只读不改，负责跑测试的子代理只执行并汇报结果，实现关注点分离。
> 
> #### Q2 — Skills 自动判断激活机制
> 
> 传统工具需要用户手动触发指令，而 Skills 让 AI 能自动理解意图——当你说"帮我看看这段代码有没有安全问题"，AI 自动判断这是安全审查任务并激活对应 Skill，无需手动选择。
> 
> #### Q3 — 课程目标与核心工程痛点
> 
> 课程从真实工程卡点出发而非功能讲解，核心围绕 Memory（解决 Agent 无记忆、不理解项目背景）和 Sub-Agents（解决角色混乱、上下文污染）等问题，目标是将 Claude Code 打造成可持续运转的 AI 工程团队。
