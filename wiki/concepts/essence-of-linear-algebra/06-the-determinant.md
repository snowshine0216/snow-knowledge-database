...
## Outline
1. [Area Scaling as the Core Intuition](wiki/concepts/essence-of-linear-algebra/06-the-determinant.md#area-scaling-as-the-core-intuition)
2. [The 2×2 Determinant Formula](wiki/concepts/essence-of-linear-algebra/06-the-determinant.md#the-2x2-determinant-formula)
3. [Determinant of Zero: Space Collapses](wiki/concepts/essence-of-linear-algebra/06-the-determinant.md#determinant-of-zero-space-collapses)
4. [Negative Determinants: Orientation Flipping](wiki/concepts/essence-of-linear-algebra/06-the-determinant.md#negative-determinants-orientation-flipping)
5. [The 3×3 Determinant and Volume](wiki/concepts/essence-of-linear-algebra/06-the-determinant.md#the-3x3-determinant-and-volume)
6. [Determinants Compose Multiplicatively](wiki/concepts/essence-of-linear-algebra/06-the-determinant.md#determinants-compose-multiplicatively)
