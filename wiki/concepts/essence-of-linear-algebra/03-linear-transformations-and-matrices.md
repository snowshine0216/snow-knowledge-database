...
## Outline
1. [What Makes a Transformation Linear](wiki/concepts/essence-of-linear-algebra/03-linear-transformations-and-matrices.md#what-makes-a-transformation-linear)
2. [Basis Vectors Determine Everything](wiki/concepts/essence-of-linear-algebra/03-linear-transformations-and-matrices.md#basis-vectors-determine-everything)
3. [Matrices as Packaged Transformations](wiki/concepts/essence-of-linear-algebra/03-linear-transformations-and-matrices.md#matrices-as-packaged-transformations)
4. [Matrix-Vector Multiplication as a Column Combination](wiki/concepts/essence-of-linear-algebra/03-linear-transformations-and-matrices.md#matrix-vector-multiplication-as-a-column-combination)
5. [Special Cases and Geometric Intuition](wiki/concepts/essence-of-linear-algebra/03-linear-transformations-and-matrices.md#special-cases-and-geometric-intuition)
6. [Generalization to Higher Dimensions](wiki/concepts/essence-of-linear-algebra/03-linear-transformations-and-matrices.md#generalization-to-higher-dimensions)
