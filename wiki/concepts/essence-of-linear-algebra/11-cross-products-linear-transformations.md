...
## Outline
1. [Recap — the Cross Product as Signed Area and Direction](wiki/concepts/essence-of-linear-algebra/11-cross-products-linear-transformations.md#recap)
2. [The Determinant Function is Linear in v](wiki/concepts/essence-of-linear-algebra/11-cross-products-linear-transformations.md#determinant-function)
3. [Duality — Every Linear Map from 3D to ℝ is a Dot Product](wiki/concepts/essence-of-linear-algebra/11-cross-products-linear-transformations.md#duality)
4. [The Cross Product Defined Through Duality](wiki/concepts/essence-of-linear-algebra/11-cross-products-linear-transformations.md#cross-product-via-duality)
5. [Computing the Cross Product via the Symbolic Determinant Trick](wiki/concepts/essence-of-linear-algebra/11-cross-products-linear-transformations.md#symbolic-determinant)
6. [Why the Cross Product is Perpendicular to Both Inputs](wiki/concepts/essence-of-linear-algebra/11-cross-products-linear-transformations.md#perpendicularity)
7. [The Broader Lesson — Duality as a Recurring Theme](wiki/concepts/essence-of-linear-algebra/11-cross-products-linear-transformations.md#broader-lesson)
