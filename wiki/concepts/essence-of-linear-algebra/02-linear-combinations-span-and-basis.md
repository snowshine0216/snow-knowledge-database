...
## Outline
1. [Coordinates as Scalars on Basis Vectors](wiki/concepts/essence-of-linear-algebra/02-linear-combinations-span-and-basis.md#coordinates-as-scalars-on-basis-vectors)
2. [Linear Combinations](wiki/concepts/essence-of-linear-algebra/02-linear-combinations-span-and-basis.md#linear-combinations)
3. [The Span of a Set of Vectors](wiki/concepts/essence-of-linear-algebra/02-linear-combinations-span-and-basis.md#the-span-of-a-set-of-vectors)
4. [Collinear Vectors and Redundancy](wiki/concepts/essence-of-linear-algebra/02-linear-combinations-span-and-basis.md#collinear-vectors-and-redundancy)
5. [Linear Dependence vs. Linear Independence](wiki/concepts/essence-of-linear-algebra/02-linear-combinations-span-and-basis.md#linear-dependence-vs-linear-independence)
6. [Basis Vectors and the Definition of a Basis](wiki/concepts/essence-of-linear-algebra/02-linear-combinations-span-and-basis.md#basis-vectors-and-the-definition-of-a-basis)
