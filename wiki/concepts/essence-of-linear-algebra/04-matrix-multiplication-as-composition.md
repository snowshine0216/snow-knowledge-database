...
## Outline
1. [Matrices as Transformations — Recap](wiki/concepts/essence-of-linear-algebra/04-matrix-multiplication-as-composition.md#matrices-as-transformations)
2. [Composing Two Transformations](wiki/concepts/essence-of-linear-algebra/04-matrix-multiplication-as-composition.md#composing-two-transformations)
3. [Deriving the Product Formula](wiki/concepts/essence-of-linear-algebra/04-matrix-multiplication-as-composition.md#deriving-the-product-formula)
4. [Right-to-Left Reading Order](wiki/concepts/essence-of-linear-algebra/04-matrix-multiplication-as-composition.md#right-to-left-reading-order)
5. [Non-Commutativity](wiki/concepts/essence-of-linear-algebra/04-matrix-multiplication-as-composition.md#non-commutativity)
6. [Associativity Is Geometrically Obvious](wiki/concepts/essence-of-linear-algebra/04-matrix-multiplication-as-composition.md#associativity)
