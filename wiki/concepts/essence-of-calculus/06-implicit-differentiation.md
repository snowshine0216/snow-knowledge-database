...
## Outline
- [Core Idea](wiki/concepts/essence-of-calculus/06-implicit-differentiation.md#core-idea)
- [Key Concepts](wiki/concepts/essence-of-calculus/06-implicit-differentiation.md#key-concepts)
- [Why the Chain Rule Creates dy/dx](wiki/concepts/essence-of-calculus/06-implicit-differentiation.md#why-the-chain-rule-creates-dydx)
- [Worked Examples](wiki/concepts/essence-of-calculus/06-implicit-differentiation.md#worked-examples)
- [The General Formula](wiki/concepts/essence-of-calculus/06-implicit-differentiation.md#the-general-formula)
- [Key Equations](wiki/concepts/essence-of-calculus/06-implicit-differentiation.md#key-equations)
- [Connections](wiki/concepts/essence-of-calculus/06-implicit-differentiation.md#connections)
