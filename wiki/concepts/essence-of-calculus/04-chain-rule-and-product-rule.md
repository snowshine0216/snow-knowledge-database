...
## Outline
- [Core Idea](wiki/concepts/essence-of-calculus/04-chain-rule-and-product-rule.md#core-idea)
- [Product Rule via Rectangle Geometry](wiki/concepts/essence-of-calculus/04-chain-rule-and-product-rule.md#product-rule-via-rectangle-geometry)
- [Chain Rule via Cascading Nudges](wiki/concepts/essence-of-calculus/04-chain-rule-and-product-rule.md#chain-rule-via-cascading-nudges)
- [Worked Examples](wiki/concepts/essence-of-calculus/04-chain-rule-and-product-rule.md#worked-examples)
- [Key Equations](wiki/concepts/essence-of-calculus/04-chain-rule-and-product-rule.md#key-equations)
- [Connections](wiki/concepts/essence-of-calculus/04-chain-rule-and-product-rule.md#connections)
