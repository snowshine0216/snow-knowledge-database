...
## Outline
- [Core Idea](wiki/concepts/essence-of-calculus/03-derivative-formulas-through-geometry.md#core-idea)
- [Power Rule via Areas and Volumes](wiki/concepts/essence-of-calculus/03-derivative-formulas-through-geometry.md#power-rule-via-areas-and-volumes)
- [Trig Derivatives via the Unit Circle](wiki/concepts/essence-of-calculus/03-derivative-formulas-through-geometry.md#trig-derivatives-via-the-unit-circle)
- [Extending the Power Rule](wiki/concepts/essence-of-calculus/03-derivative-formulas-through-geometry.md#extending-the-power-rule)
- [Key Equations](wiki/concepts/essence-of-calculus/03-derivative-formulas-through-geometry.md#key-equations)
- [Connections](wiki/concepts/essence-of-calculus/03-derivative-formulas-through-geometry.md#connections)
