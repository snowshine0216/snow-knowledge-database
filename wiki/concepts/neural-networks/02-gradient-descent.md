...
## Outline
1. [The Cost Function](wiki/concepts/neural-networks/02-gradient-descent.md#cost-function)
2. [Parameter Space](wiki/concepts/neural-networks/02-gradient-descent.md#parameter-space)
3. [The Gradient — Direction of Steepest Ascent](wiki/concepts/neural-networks/02-gradient-descent.md#gradient)
4. [Gradient Descent Update Rule](wiki/concepts/neural-networks/02-gradient-descent.md#update-rule)
5. [Learning Rate](wiki/concepts/neural-networks/02-gradient-descent.md#learning-rate)
6. [Mini-batch and Stochastic Gradient Descent](wiki/concepts/neural-networks/02-gradient-descent.md#mini-batch-sgd)
