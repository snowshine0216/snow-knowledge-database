...
## Outline
1. [Motivation — Context-Dependent Meaning](wiki/concepts/neural-networks/08-attention.md#motivation)
2. [Query, Key, Value Projections](wiki/concepts/neural-networks/08-attention.md#qkv-projections)
3. [Attention Score Computation](wiki/concepts/neural-networks/08-attention.md#attention-scores)
4. [Softmax Normalization](wiki/concepts/neural-networks/08-attention.md#softmax-normalization)
5. [Weighted Aggregation (Value Mixing)](wiki/concepts/neural-networks/08-attention.md#value-mixing)
6. [Causal Masking](wiki/concepts/neural-networks/08-attention.md#causal-masking)
7. [Multi-Head Attention](wiki/concepts/neural-networks/08-attention.md#multi-head)
8. [Parameter Count](wiki/concepts/neural-networks/08-attention.md#parameter-count)
