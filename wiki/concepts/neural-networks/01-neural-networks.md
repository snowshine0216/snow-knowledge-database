...
## Outline
1. [Motivating Example — Digit Recognition](wiki/concepts/neural-networks/01-neural-networks.md#motivating-example)
2. [Neuron Model](wiki/concepts/neural-networks/01-neural-networks.md#neuron-model)
3. [Network Architecture](wiki/concepts/neural-networks/01-neural-networks.md#network-architecture)
4. [Activation Functions](wiki/concepts/neural-networks/01-neural-networks.md#activation-functions)
5. [Matrix Form of the Forward Pass](wiki/concepts/neural-networks/01-neural-networks.md#matrix-form)
6. [The Learning Problem](wiki/concepts/neural-networks/01-neural-networks.md#the-learning-problem)
