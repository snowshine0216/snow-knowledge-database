...
## Outline
1. [Language Model as a Function](wiki/concepts/neural-networks/06-mini-llm.md#language-model-function)
2. [Tokenization](wiki/concepts/neural-networks/06-mini-llm.md#tokenization)
3. [Autoregressive Generation Loop](wiki/concepts/neural-networks/06-mini-llm.md#generation-loop)
4. [Training Objective](wiki/concepts/neural-networks/06-mini-llm.md#training-objective)
5. [Temperature and Sampling](wiki/concepts/neural-networks/06-mini-llm.md#temperature-sampling)
