...
## Outline
1. [The Problem of Multiple Coordinate Systems](#the-problem-of-multiple-coordinate-systems)
2. [The Basis Matrix and Translating Into Our Language](#the-basis-matrix-and-translating-into-our-language)
3. [Translating Back with the Inverse](#translating-back-with-the-inverse)
4. [Transforming Transformations — The Conjugation Formula](#transforming-transformations-the-conjugation-formula)
5. [Why Conjugation Preserves Geometric Meaning](#why-conjugation-preserves-geometric-meaning)
6. [Connection to Eigenvectors and Diagonalization](#connection-to-eigenvectors-and-diagonalization)
