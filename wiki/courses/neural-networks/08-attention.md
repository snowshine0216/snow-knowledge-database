...
## Outline
1. [Motivation — Context-Dependent Meaning](wiki/courses/neural-networks/08-attention.md#motivation)
2. [Query, Key, Value Projections](wiki/courses/neural-networks/08-attention.md#qkv-projections)
3. [Attention Score Computation](wiki/courses/neural-networks/08-attention.md#attention-scores)
4. [Softmax Normalization](wiki/courses/neural-networks/08-attention.md#softmax-normalization)
5. [Weighted Aggregation (Value Mixing)](wiki/courses/neural-networks/08-attention.md#value-mixing)
6. [Causal Masking](wiki/courses/neural-networks/08-attention.md#causal-masking)
7. [Multi-Head Attention](wiki/courses/neural-networks/08-attention.md#multi-head)
8. [Parameter Count](wiki/courses/neural-networks/08-attention.md#parameter-count)
