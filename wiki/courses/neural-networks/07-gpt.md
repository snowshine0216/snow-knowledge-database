...
## Outline
1. [GPT Architecture Overview](wiki/courses/neural-networks/07-gpt.md#architecture-overview)
2. [Tokenization](wiki/courses/neural-networks/07-gpt.md#tokenization)
3. [Token Embeddings](wiki/courses/neural-networks/07-gpt.md#token-embeddings)
4. [Positional Encoding](wiki/courses/neural-networks/07-gpt.md#positional-encoding)
5. [Stacked Transformer Blocks](wiki/courses/neural-networks/07-gpt.md#transformer-blocks)
6. [Unembedding and Softmax](wiki/courses/neural-networks/07-gpt.md#unembedding-softmax)
7. [Autoregressive Generation](wiki/courses/neural-networks/07-gpt.md#autoregressive-generation)
