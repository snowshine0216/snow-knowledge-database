...
## Outline
1. [Testing a Trained Network](wiki/courses/neural-networks/03-neural-network-analysis.md#testing)
2. [MNIST Accuracy and Performance Metrics](wiki/courses/neural-networks/03-neural-network-analysis.md#accuracy)
3. [Inspecting Hidden Neurons](wiki/courses/neural-networks/03-neural-network-analysis.md#hidden-neurons)
4. [Failure Modes and Ambiguous Inputs](wiki/courses/neural-networks/03-neural-network-analysis.md#failure-modes)
5. [Empirical Probing](wiki/courses/neural-networks/03-neural-network-analysis.md#empirical-probing)
6. [Bridge to Gradient Computation](wiki/courses/neural-networks/03-neural-network-analysis.md#bridge)
