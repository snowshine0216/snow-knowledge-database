...
## Outline
1. [Generative Modeling Overview](wiki/courses/neural-networks/10-diffusion-models.md#generative-modeling)
2. [Forward Diffusion Process](wiki/courses/neural-networks/10-diffusion-models.md#forward-diffusion)
3. [Reverse Process — Iterative Denoising](wiki/courses/neural-networks/10-diffusion-models.md#reverse-process)
4. [Denoising Network (Score Model)](wiki/courses/neural-networks/10-diffusion-models.md#denoising-network)
5. [Training Objective](wiki/courses/neural-networks/10-diffusion-models.md#training-objective)
6. [Text Conditioning via CLIP](wiki/courses/neural-networks/10-diffusion-models.md#text-conditioning)
