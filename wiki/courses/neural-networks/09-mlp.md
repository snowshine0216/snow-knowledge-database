...
## Outline
1. [MLP Role in Transformers](wiki/courses/neural-networks/09-mlp.md#mlp-role)
2. [MLP Forward Computation](wiki/courses/neural-networks/09-mlp.md#mlp-forward)
3. [Activation Functions: ReLU and GELU](wiki/courses/neural-networks/09-mlp.md#activation-functions)
4. [What Feature Neurons Store](wiki/courses/neural-networks/09-mlp.md#feature-neurons)
5. [Superposition Hypothesis](wiki/courses/neural-networks/09-mlp.md#superposition)
6. [Interpretability Limits](wiki/courses/neural-networks/09-mlp.md#interpretability-limits)
