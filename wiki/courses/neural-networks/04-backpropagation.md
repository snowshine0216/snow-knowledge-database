...
## Outline
1. [What Backprop Computes](wiki/courses/neural-networks/04-backpropagation.md#what-backprop-computes)
2. [Local Sensitivity Intuition](wiki/courses/neural-networks/04-backpropagation.md#local-sensitivity)
3. [Chain Rule Flow](wiki/courses/neural-networks/04-backpropagation.md#chain-rule-flow)
4. [Error Signal Propagation](wiki/courses/neural-networks/04-backpropagation.md#error-signal-propagation)
5. [Why Not Finite Differences?](wiki/courses/neural-networks/04-backpropagation.md#why-not-finite-differences)
6. [Integration with the SGD Training Loop](wiki/courses/neural-networks/04-backpropagation.md#sgd-integration)
