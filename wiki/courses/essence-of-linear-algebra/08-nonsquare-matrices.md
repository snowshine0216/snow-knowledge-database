...
## Outline
1. [Extending Linear Transformations Beyond Square Matrices](wiki/courses/essence-of-linear-algebra/08-nonsquare-matrices.md#extending-linear-transformations)
2. [Reading Dimensions from a Matrix's Shape](wiki/courses/essence-of-linear-algebra/08-nonsquare-matrices.md#reading-dimensions)
3. [3×2 Matrices — Mapping 2D into 3D](wiki/courses/essence-of-linear-algebra/08-nonsquare-matrices.md#3x2-matrices)
4. [2×3 Matrices — Mapping 3D Down to 2D](wiki/courses/essence-of-linear-algebra/08-nonsquare-matrices.md#2x3-matrices)
5. [1×2 Matrices — Mapping 2D onto the Number Line](wiki/courses/essence-of-linear-algebra/08-nonsquare-matrices.md#1x2-matrices)
