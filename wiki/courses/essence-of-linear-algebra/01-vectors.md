...
## Outline
1. [Three Perspectives on Vectors](wiki/courses/essence-of-linear-algebra/01-vectors.md#three-perspectives-on-vectors)
2. [Coordinates as Instructions from the Origin](wiki/courses/essence-of-linear-algebra/01-vectors.md#coordinates-as-instructions-from-the-origin)
3. [Vector Addition — the Tip-to-Tail Rule](wiki/courses/essence-of-linear-algebra/01-vectors.md#vector-addition--the-tip-to-tail-rule)
4. [Scalar Multiplication — Stretching, Shrinking, and Flipping](wiki/courses/essence-of-linear-algebra/01-vectors.md#scalar-multiplication--stretching-shrinking-and-flipping)
5. [Why the Origin Matters](wiki/courses/essence-of-linear-algebra/01-vectors.md#why-the-origin-matters)
