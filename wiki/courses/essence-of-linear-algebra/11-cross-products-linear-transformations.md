...
## Outline
1. [Recap — the Cross Product as Signed Area and Direction](wiki/courses/essence-of-linear-algebra/11-cross-products-linear-transformations.md#recap)
2. [The Determinant Function is Linear in v](wiki/courses/essence-of-linear-algebra/11-cross-products-linear-transformations.md#determinant-function)
3. [Duality — Every Linear Map from 3D to ℝ is a Dot Product](wiki/courses/essence-of-linear-algebra/11-cross-products-linear-transformations.md#duality)
4. [The Cross Product Defined Through Duality](wiki/courses/essence-of-linear-algebra/11-cross-products-linear-transformations.md#cross-product-via-duality)
5. [Computing the Cross Product via the Symbolic Determinant Trick](wiki/courses/essence-of-linear-algebra/11-cross-products-linear-transformations.md#symbolic-determinant)
6. [Why the Cross Product is Perpendicular to Both Inputs](wiki/courses/essence-of-linear-algebra/11-cross-products-linear-transformations.md#perpendicularity)
7. [The Broader Lesson — Duality as a Recurring Theme](wiki/courses/essence-of-linear-algebra/11-cross-products-linear-transformations.md#broader-lesson)
