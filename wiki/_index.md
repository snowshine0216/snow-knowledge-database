...
| [Karpathy From Scratch Series](workflows/karpathy-from-scratch-series.md) | neural-networks, backpropagation, tokenization, transformers, gpt, andrej-karpathy, from-scratch | Three-part hands-on series: micrograd (autograd) → minBPE (tokenizer) → nanoGPT (full Transformer), building the LLM stack from zero |
| [3Blue1Brown Deep Learning Series](concepts/3b1b-deep-learning.md) | neural-networks, deep-learning, 3blue1brown, backpropagation, transformers, attention, diffusion | 10-chapter visual series from neurons and gradient descent through attention, transformers, MLP interpretability, and diffusion models |
| [StatQuest Neural Networks and AI](concepts/statquest-neural-networks.md) | neural-networks, deep-learning, statquest, cnn, rnn, lstm, transformers, word-embedding, pytorch | 14-chapter illustrated guide covering fundamentals, CNNs, RNNs, LSTMs, word embeddings, attention, and all three transformer variants with PyTorch code |
| [Essence of Calculus](concepts/essence-of-calculus.md) | calculus, math, 3blue1brown, derivatives, integrals, taylor-series, euler | 3Blue1Brown's 12-chapter calculus series: decomposition strategy, derivatives, FTC, Taylor series, Euler's formula |
| [Essence of Linear Algebra](concepts/essence-of-linear-algebra.md) | linear-algebra, math, 3blue1brown, vectors, matrices, transformations, eigenvectors | 3Blue1Brown's 16-chapter linear algebra series: geometric intuition for vectors, transformations, determinants, eigenvectors |
| [Claude Code Engineering Course](workflows/claude-code-engineering-course.md) | claude-code, geektime, sub-agents, skills, hooks, mcp, tools, engineering | 22-chapter GeekTime course on orchestrating Claude Code as an AI engineering team via memory, sub-agents, skills, and hooks |
...
| [Zero to Hero 01: micrograd](workflows/karpathy-zero-to-hero-01-micrograd.md) | neural-networks, backpropagation, autograd, andrej-karpathy, zero-to-hero | Build a ~150-line autograd engine from scratch; demystifies backpropagation at the scalar level |
| [Zero to Hero 02: Bigrams](workflows/karpathy-zero-to-hero-02-makemore-bigrams.md) | language-model, bigram, character-level, pytorch, zero-to-hero | Bigram language model via counting and neural net — proves they converge to the same solution |
| [Zero to Hero 03: MLP](workflows/karpathy-zero-to-hero-03-makemore-mlp.md) | multilayer-perceptron, embeddings, language-model, zero-to-hero | MLP language model (Bengio 2003): embeddings, minibatch training, LR search, train/dev/test splits |
| [Zero to Hero: Build GPT](workflows/karpathy-zero-to-hero-build-gpt.md) | gpt, transformers, self-attention, nanoGPT, zero-to-hero | Build a decoder-only Transformer in ~200 lines; self-attention v1→v4, multi-head, residual, LayerNorm |
| [Zero to Hero: GPT Tokenizer](workflows/karpathy-zero-to-hero-gpt-tokenizer.md) | tokenization, bpe, tiktoken, sentencepiece, zero-to-hero | BPE tokenizer from scratch; explains LLM quirks (spelling, arithmetic, glitch tokens) via tokenization |
