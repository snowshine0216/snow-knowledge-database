...
| [Docker Containerization and Image Build Workflow (Part 1)](concepts/075-docker-containerization-1.md) | docker, fastapi, uvicorn, langgraph, deployment | FastAPI + Uvicorn containerization stack for AI model delivery, covering the three key deployment challenges and code modularization best practices. |
| [Docker Containerization and Image Build Workflow (Part 2)](concepts/076-docker-containerization-2.md) | docker, docker-compose, dify, deployment | Dify's multi-container production architecture as a reference case; Docker Compose management and early-version strategy for reading large open-source codebases. |
| [Building a Basic Model Service with FastAPI](concepts/077-fastapi-model-service.md) | fastapi, ollama, vllm, model-service, streaming | Wrapping Ollama/VLLM/Transformer models with FastAPI to expose standardized HTTP interfaces with streaming support and health checks. |
| [Kubernetes Orchestration Basics for AI Deployments](concepts/078-kubernetes-orchestration-basics.md) | kubernetes, k8s, hpa, rolling-update, canary | K8s Pod/Deployment/Service concepts for AI developers; covers HPA autoscaling, rolling updates, blue-green and canary release strategies. |
| [Building a Monitoring System for AI Services](concepts/079-monitoring-system.md) | prometheus, grafana, monitoring, observability, ollama, docker | Prometheus + Grafana + Ollama Exporter stack for monitoring AI inference services in production |
| [Building a Log Collection System](concepts/080-log-collection-system.md) | elk, logstash, elasticsearch, kibana, fluentd, logging | ELK stack for structured log collection with Python TCP shipping and Kibana visualization |
| [Async Programming Core Concepts Part 1](concepts/081-async-core-concepts-1.md) | asyncio, async, await, coroutine, event-loop, python | Processes vs threads vs coroutines, yield-to-async/await evolution, event loop mechanics and asyncio.gather |
| [Async Programming Core Concepts Part 2](concepts/082-async-core-concepts-2.md) | asyncio, await, awaitable, magic-methods, bytecode, python | Awaitable protocol via __await__, manual coroutine execution, YIELD_VALUE bytecode, and performance benchmarking |
| [Parallel Mechanisms Comparison Part 1](concepts/083-parallel-mechanisms-1.md) | asyncio, threading, multiprocessing, gil, concurrent-futures, numpy | GIL proven as fake parallelism for CPU tasks, NumPy C-extension bypass, coroutine vs thread context switch cost |
| [Python Parallel Mechanisms Part 2](concepts/084-parallel-mechanisms-2.md) | python, async, concurrency, multiprocessing, cprofile, pyspy | cProfile and py-spy profiling tools; process pool + coroutine hybrid architecture for mixed CPU/IO workloads |
| [FastAPI Deep Integration Part 1](concepts/085-fastapi-deep-integration-1.md) | fastapi, pydantic, websocket, redis, async | RESTful design principles, Pydantic LLM output validation with JSON Schema, WebSocket streaming, Redis exact-match caching |
| [FastAPI Deep Integration Part 2](concepts/086-fastapi-deep-integration-2.md) | asyncpg, sqlalchemy, orm, token-bucket, redis, postgresql | asyncpg vs SQLAlchemy ORM for async DB access; token bucket rate limiting middleware; fail-fast exception strategy |
...
| [LangChain Async Advanced Part 2](concepts/088-langchain-async-vectordb-gpu-2.md) | langgraph, async, timeout, retry, faiss, gpu, cuda | LangGraph async node timeout decorators; exponential backoff + jitter retry; Faiss GPU acceleration with automatic CPU fallback |
| [Capstone Project Background](concepts/089-project-background.md) | ai-engineering, capstone-project, customer-service, rag | Introduces the AI customer service capstone project: LLM product development philosophy, vertical-first strategy, and analogous scenario prototyping. |
...
| [AI Product: From Functional to Actually Good](concepts/095-ai-product-from-functional-to-good.md) | ai-product, product-thinking, ux, error-tolerance, data-flywheel, cost-optimization, dsl, requirements-engineering | How AI products cross from "functional" to "actually good" via product thinking, DSL-anchored requirements, three-layer error tolerance, cost economics, and data flywheel design. |
| [Deep Waters of Vertical Domain AI (Part 1)](concepts/096-vertical-domain-deep-water-1.md) | vertical-domain, law, finance, rag, hybrid-search, knowledge-graph | Engineering solutions for law (granularity mismatch, keyword loss, hybrid search, knowledge graph) and finance (OCR parsing, sandbox execution, numeric hallucination) domains. |
| [Deep Waters of Vertical Domain AI (Part 2)](concepts/097-vertical-domain-deep-water-2.md) | vertical-domain, medical, guardrail, human-in-the-loop, multi-agent | Healthcare AI challenges: ontology mapping for dirty terminology data, two-stage guardrail system (pre/post-generation), and Human-in-the-Loop pre-consultation architecture. |
| [AI Ethics, Data Compliance, and Governance](concepts/098-ai-ethics-compliance-governance.md) | ai-ethics, data-compliance, governance, privacy, fairness, security, llm | Fairness/bias detection, PII/PHI de-identification pipelines, differential privacy, federated learning, prompt injection defense, and continuous governance frameworks for AI systems. |
